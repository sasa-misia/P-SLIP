...
PARAMETER_CLASS_NAME_MAPPER = {
    ...
    'soil': [
        'slp',
        {
            ...
            7: {'GS':2.65, 'gd':25.0, 'c':3e4, 'cr':0, 'phi':35, 'kt':1e-3, 'beta':1, 'A':40,   'n':0.25, 'E':1e4, 'ni':0.20, 'info':'Rocky soils - Fractured rock with soil matrix or compacted rock'},
            8: {'GS':2.60, 'gd':18.0, 'c':0,   'cr':0, 'phi':40, 'kt':2e-2, 'beta':1, 'A':40,   'n':0.3,  'E':120, 'ni':0.27, 'info':'Gravel soils - Coarse-grained, high permeability'}
        }
    ],
    'vegetation': [
        'vgp',
